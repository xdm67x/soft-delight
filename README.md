...
A comfortable, eye-friendly VS Code theme for developers who spend long hours coding. Features both a light and dark variant with carefully selected colors that provide excellent contrast without causing eye strain.

## Features

- **Two Beautiful Variants**: Light theme for daytime coding, Dark Edition for nighttime sessions
- **Eye-Friendly Palette**: Soft, pastel-inspired colors that reduce eye fatigue
- **Excellent Contrast**: Carefully tuned colors ensure readability without harsh contrasts
- **No Harsh Reds**: Warm oranges and indigos replace aggressive reds
- **Developer-Focused**: Optimized syntax highlighting for TypeScript, JavaScript, Python, Rust, and more

## Screenshots

### Soft DeLight (Light Theme)

![Soft DeLight Light Theme](images/light.png)

### Soft DeLight Dark Edition

![Soft DeLight Dark Theme](images/dark.png)
...
| Keywords | Soft Purple | `#7C3AED` |
| Strings | Deep Indigo | `#4338CA` |
| Functions | Steel Blue | `#0369A1` |
| Types/Classes | Mint Green | `#059669` |
| Numbers | Amber | `#D97706` |
| Operators | Rose | `#BE185D` |
...
- **Light theme** uses a warm off-white background (`#FAF9F6`) instead of stark white
- **Dark theme** uses a deep navy (`#1A1A2E`) instead of pure black
- Colors are vibrant but never harsh—reds are replaced with warm oranges and pinks
